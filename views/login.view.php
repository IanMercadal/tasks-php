        ...
        <main>
            ...
            <section>
                ...
                <form action="#" class="form" method="post">
                    <div class="inputBox">
                        <label>Email
                            <?php  if(isset($_SESSION["errores"]["user"])) {
                                echo "<p class='error'> - ". $_SESSION["errores"]["user"] ."</p>";
                            } ?>
                        </label>
                    ...
                    <a href="#" class="section-redirect">Forgot password?</a>
                </form>
            </section>
        </main>
    </body>
